...
- [**Wishlist API**](#wishlist-api)
  ...
  - [Update multiple Items In a  Wishlist](#update-multiple-wishlist-items)
...
Update multiple items in an existing wishlist in the TWC system.

Endpoint: ```/api/wishlist/update-multiple-items```
